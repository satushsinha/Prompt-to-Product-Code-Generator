...
def coder_agent(state: dict) -> dict:
    ...
    user_prompt = (
        ...
        "Use name read_file function to read content and list_files name function to list the files and get_current_directory name function to get the directory if required"
    )
